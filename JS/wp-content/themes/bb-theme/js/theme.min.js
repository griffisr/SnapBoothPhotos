!(function (e) {
  (FLTheme = {
    ...
    _bind: function () {
      e(
        ".fl-framework-base .navbar-toggle, .fl-framework-base-4 .navbar-toggle"
      ).on("click", this.navbarToggleClick),
          ...
          (o = new Image()),
            ...
            a.width() < window.themeopts.mobile_breakpoint
              ...
              : "undefined" != typeof t.data("src") &&
                (t.attr("src", t.data("src")), t.css("width", ""));
        });
    },
    navbarToggleClick: function (a) {
      var l = e(a.target).closest("button"),
        n = e(l.data("target"));
      ...
      "undefined" != typeof FLBuilderLayout &&
        (("undefined" != typeof window.themeopts.smooth &&
          ...
          (location.hash &&
            ...
            setTimeout(function () {
              window.scrollTo(0, 0),
                FLBuilderLayout._scrollToElement(e(location.hash));
            }, 1)));
    },
    ...
    _setupMobileNavLayout: function () {
      var a = e(window),
        ...
        f = n.find(".fl-page-header-logo").offset();
    ...
    _toggleMobileNavLayout: function () {
      e(".fl-page-nav").on("click", ".navbar-toggle", function () {
        e(".fl-page").toggleClass("fl-nav-offcanvas-active");
      }),
        e(".fl-page-nav").on("click", ".fl-offcanvas-close", function () {
          e(".fl-page").toggleClass("fl-nav-offcanvas-active");
        }),
        e(".fl-page").on("click", ".fl-offcanvas-opacity", function () {
          e(".fl-page").toggleClass("fl-nav-offcanvas-active");
        }),
        e(".fl-framework-base.fl-nav-mobile-offcanvas .navbar-toggle").on(
          "click",
          function () {
            e(".fl-page").toggleClass("fl-nav-offcanvas-active");
          }
        ),
        e(".fl-framework-base-4.fl-nav-mobile-offcanvas .navbar-toggle").on(
          "click",
          function () {
            e(".fl-page").toggleClass("fl-nav-offcanvas-active");
          }
